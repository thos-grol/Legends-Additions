this.anatomist_potion_item <- this.inherit("scripts/items/item", {
	...
	{
		this.Sound.play("sounds/combat/drink_0" + ::Math.rand(1, 3) + ".wav", ::Const.Sound.Volume.Inventory);
        ...
        {
            this.Sound.play("sounds/humans/legends/woman_death_0" + ::Math.rand(1, 8) + ".wav", ::Const.Sound.Volume.Inventory);
            this.Sound.play("sounds/humans/legends/woman_flee_0" + ::Math.rand(1, 6) + ".wav", ::Const.Sound.Volume.Inventory);
        }
        else
        {
