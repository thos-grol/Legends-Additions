...
::Const.Strings.PerkDescription.SpellHaunt <- "Undead rise!..." //FIXME: DESCRIPTION Haunt
+ "\n\n" + ::MSU.Text.color(::Z.Log.Color.Blue, "\'Reanimate\' (4 AP, 20 Fat, 1 Mana):") //FIXME: DESCRIPTION Haunt
+ "\n";
