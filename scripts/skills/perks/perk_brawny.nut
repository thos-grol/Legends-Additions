::Const.Strings.PerkName.Brawny = "Load Training";
::Const.Strings.PerkDescription.Brawny = "Greater fitness, heavier armor..."
+ "\n\n" + ::MSU.Text.color(::Z.Color.Blue, "Passive:")
+ "\n"+::MSU.Text.colorGreen("– 30%") + " Endurance and Agility penalty from armor"
+ "\n\n" + ::MSU.Text.color(::Z.Color.Blue, "While over 90% Fatigued:")
+ "\n"+::MSU.Text.colorGreen("+5") + " Fatigue recovery";

::Const.Perks.PerkDefObjects[::Const.Perks.PerkDefs.Brawny].Name = ::Const.Strings.PerkName.Brawny;
