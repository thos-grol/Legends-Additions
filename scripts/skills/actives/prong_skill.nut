this.prong_skill <- this.inherit("scripts/skills/skill", {
	...
	function create()
	{
		...
		this.m.Name = "Prong";
		this.m.Description = "A thrusting attack that can cover the distance of 3 tiles and can be used from behind the frontline, outside the range of most melee weapons.";
