	...
	function create()
	{
		...
		this.m.Screens.push({
			...
			function start( _event )
			{
				...
				local trait = ::new("scripts/skills/traits/dexterous_trait");
		...
		this.m.Screens.push({
			ID = "F",
			Text = "[img]gfx/ui/events/event_163.png[/img]{You offer five hundred crowns to the dancer. She keeps picking up coins - one at a time - and putting them in her clay pot. It is almost a silent affair, coins clapping loudly as they fall into a nearly empty barrel of clay. He looks up, looks down. She puts in one more crown then gets to her feet. She strips off her clothes and holds out his hand.%SPEECH_ON%The Gilded One must be gleaming upon us both, for you to have earned such keep, and no doubt He has guided your purse here to bring it to me.%SPEECH_OFF%You nod and shake her hand. A passerby glances over and scratches his head.%SPEECH_ON%Wait a minute, you\'ve a snake down there! I thought you were a lady of the dance, but this...%SPEECH_OFF%He dabs his forehead and lowers his voice.%SPEECH_ON%This makes it even better.%SPEECH_OFF%Sighing, the dancer asks that she take a look at your inventory.%SPEECH_ON%A body like mine, anything will fit, inside or out, I\'ll make it work.%SPEECH_OFF%}",
			Image = "",
			List = [],
			Characters = [],
			Options = [
