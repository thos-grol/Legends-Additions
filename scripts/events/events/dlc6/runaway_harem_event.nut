	...
	function create()
	{
		...
		this.m.Screens.push({
			...
			function start( _event )
			{
				...
				_event.m.Dude.getItems().equip(::new("scripts/items/weapons/oriental/qatal_dagger"));
				...
				_event.m.Dude.getSkills().add(::new("scripts/skills/perks/perk_coup_de_grace"));
				_event.m.Dude.getSkills().add(::new("scripts/skills/perks/perk_legend_favoured_enemy_southerner"));
				_event.m.Dude.getSkills().add(::new("scripts/skills/traits/natural_trait"));
				_event.m.Dude.getSkills().add(::new("scripts/skills/traits/pragmatic_trait"));
