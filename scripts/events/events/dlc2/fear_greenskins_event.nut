	...
	function create()
	{
		...
		this.m.Screens.push({
			...
			function start( _event )
			{
				...
				local trait = ::new("scripts/skills/traits/fear_greenskins_trait");
