this.orc_warrior <- this.inherit("scripts/entity/tactical/abstract_actor", {
	m = {},
	function create()
	{
		this.m.Type = ::Const.EntityType.OrcWarrior;
		this.m.BloodType = ::Const.BloodType.Red;
		this.m.XP = ::Const.Tactical.Actor.OrcWarrior.XP;
