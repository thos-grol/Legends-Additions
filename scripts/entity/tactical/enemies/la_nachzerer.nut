this.la_nachzerer <- this.inherit("scripts/entity/tactical/actor", {
    ...
    function onInit()
	{
		...
		//Skills
        this.m.Skills.add(this.new("scripts/skills/traits/boss_fearless_trait"));

		this.m.Skills.add(this.new("scripts/skills/actives/nachzerer_claws"));
        ...
        this.m.Skills.add(this.new("scripts/skills/actives/swallow_whole_skill")); //TODO: Rework

		this.m.Skills.add(this.new("scripts/skills/actives/gruesome_feast")); //TODO: Rework to jump to tile within 3 squares and consume the corpse.
		this.m.Skills.add(this.new("scripts/skills/effects/gruesome_feast_effect")); //TODO: investigate
