this.legend_barbarian_prisoner_contract <- this.inherit("scripts/contracts/contract", {
	m = {
		...
		ValidTypes = ::Const.LegendMod.FavoriteBarbarian
	},
	function create()
	{
	...
	function createStates()
	{
		this.m.States.push({
			...
			function end()
			{
				...
				this.World.FactionManager.getFactionOfType(::Const.FactionType.Barbarians).addSettlement(this.Contract.m.BarbCamp.get(), false);
				...
				this.Contract.addUnitsToEntity(this.Contract.m.BarbCamp, ::Const.World.Spawn.Barbarians, 200 * this.Contract.getDifficultyMult());
				this.Contract.m.BarbCamp.setResources(::Math.min(this.Contract.m.BarbCamp.getResources(), 200 * this.Contract.getDifficultyMult()));
				this.Contract.m.BarbCamp.setLootScaleBasedOnResources(200 * this.Contract.getDifficultyMult());
				this.Contract.m.BarbCamp.updateStrength();
				local party;
				party = this.World.FactionManager.getFactionOfType(::Const.FactionType.Barbarians).spawnEntity(this.Contract.m.BarbCamp.getTile(), "Barbarian Retaliation", false, ::Const.World.Spawn.Barbarians, 200 * this.Contract.getDifficultyMult());
			...
			Options = [
				{
					...
					function getResult()
					{
						...
						this.World.FactionManager.getFaction(this.Contract.getFaction()).addPlayerRelation(::Const.World.Assets.RelationCivilianContractSuccess, "Protected a prisoner wagon as promised");
			...
			Options = [
				...
				},
				{
					...
					function getResult()
					{
						...
						this.World.FactionManager.getFaction(this.Contract.getFaction()).addPlayerRelation(::Const.World.Assets.RelationCivilianContractFail, "Failed to protect a prisoner wagon");
						this.World.Assets.addMoralReputation(-5);
	...
	function spawnCaravan()
	{
		...
		local party = faction.spawnEntity(this.m.Home.getTile(), "Escort Caravan", false, ::Const.World.Spawn.Caravan, this.m.Home.getResources() * 0.8);
