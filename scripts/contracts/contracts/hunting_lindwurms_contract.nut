this.hunting_lindwurms_contract <- this.inherit("scripts/contracts/contract", {
	...
	function create()
	{
		...
		this.m.Description = "Scouts report Lindwurms getting too close to the town. Hunt the beasts down before they take a toll on the town.";
	...
	function createStates()
	{
		this.m.States.push({
			...
			function end()
			{
				...
				::Const.World.Common.addFootprintsFromTo(nearTile, party.getTile(), ::Const.BeastFootprints, ::Const.World.FootprintsType.Lindwurms, 0.75);
			...
			Options = [
				{
					...
					function getResult()
					{
						...
						this.World.FactionManager.getFaction(this.Contract.getFaction()).addPlayerRelation(::Const.World.Assets.RelationCivilianContractSuccess, "Rid the town of lindwurms");
			...
			Options = [
				{
					...
					function getResult()
					{
						...
						this.World.FactionManager.getFaction(this.Contract.getFaction()).addPlayerRelation(::Const.World.Assets.RelationCivilianContractFail * 2, "Tried to swindle the town out of money");
