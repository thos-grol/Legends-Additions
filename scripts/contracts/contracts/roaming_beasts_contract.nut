	...
	function createStates()
	{
		this.m.States.push({
			...
			function end()
			{
				...
				{
					party = this.World.FactionManager.getFactionOfType(::Const.FactionType.Beasts).spawnEntity(tile, "Direwolves", false, ::Const.World.Spawn.BanditVermes, 120 * this.Contract.getDifficultyMult());
					party.setDescription("A pack of ferocious direwolves on the hunt for prey.");
				}
