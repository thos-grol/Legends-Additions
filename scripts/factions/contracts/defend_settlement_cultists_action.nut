this.defend_settlement_cultists_action <- this.inherit("scripts/factions/faction_action", {
	m = {},
	function create()
	{
		this.m.ID = "defend_settlement_cultists_action";
	...
	function onUpdate( _faction )
	{
		...
		if (tooFar)
		{
			local bandits = this.World.FactionManager.getFactionOfType(this.Const.FactionType.Cultists).getSettlements();
	...
	{
		local contract = this.new("scripts/contracts/contracts/defend_settlement_cultists_contract");
