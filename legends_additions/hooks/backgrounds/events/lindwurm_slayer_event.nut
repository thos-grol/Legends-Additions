	...
	o.create = function()
	{
		...
		this.m.Screens.push({
			...
			function start( _event )
			{
				...
				_event.m.Dude.getItems().equip(::new("scripts/items/weapons/fighting_spear"));
				_event.m.Dude.getItems().equip(::new("scripts/items/shields/buckler_shield"));
				_event.m.Dude.getItems().equip(::new("scripts/items/helmets/heavy_mail_coif"));
				_event.m.Dude.getItems().equip(::new("scripts/items/armor/named/lindwurm_armor"));
				...
				this.List = [
					{
						...
						text = "You lose [color=" + ::Const.UI.Color.NegativeEventValue + "]5000[/color] Crowns"
					}
				];
			}
