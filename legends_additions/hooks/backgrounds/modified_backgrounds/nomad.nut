::mods_hookExactClass("skills/backgrounds/nomad_background", function(o)
{
	...
	{
		create();
		this.m.BackgroundDescription = "Any nomad that survived out in the desert will have some expertise in fighting." + " +25 subterfuge for relevant checks."  + " +20 tracking for relevant checks.";
