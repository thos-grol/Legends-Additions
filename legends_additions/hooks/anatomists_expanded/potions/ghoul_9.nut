::mods_hookExactClass("items/misc/anatomist/nachzehrer_potion_item", function (o)
{
    ...
    o.getTooltip = function()
    {
        ...
        result.push({
            ...
            text = "Gruesome Feast: Taste of the forbidden flesh. Devour a recently departed corpse to gain strength and restore your own health by " + ::MSU.Text.colorGreen( "50" ) + "."
        });
        result.push({
            id = 11,
            type = "text",
