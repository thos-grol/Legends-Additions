...
//TODO: modify after rebalancing potions
    ...
    o.add_potion <- function(name, complete)
    {
        switch(name)
        {
            ...
            case "direwolf":
                ...
                this.m.Skills.add(::new("scripts/skills/racial/werewolf_player_racial"));
                this.m.Skills.add(::new("scripts/skills/effects/direwolf_potion_effect"));
                this.m.Skills.add(::new("scripts/skills/effects/alp_potion_effect"));
                this.m.Skills.add(::new("scripts/skills/perks/perk_ptr_survival_instinct"));
            ...
            case "ghoul":
                ...
                this.m.Skills.add(::new("scripts/skills/effects/nachzehrer_potion_effect"));
            ...
            case "orc":
                ...
                if (complete)
                {
                    ...
                    this.m.Skills.add(::new("scripts/skills/effects/orc_berserker_potion_effect"));
                }
                break;
            case "necrosavant":
            ...
            case "goblin":
                ...
                this.m.Skills.add(::new("scripts/skills/effects/goblin_grunt_potion_effect"));
                this.m.Skills.add(::new("scripts/skills/perks/perk_footwork"));
                this.m.Skills.add(::new("scripts/skills/perks/perk_ptr_nailed_it"));
                break;
        }
