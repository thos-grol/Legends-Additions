::mods_hookExactClass("skills/backgrounds/poacher_background", function(o)
{
	...
	{
		create();
        this.m.BackgroundDescription = "Poachers tend to have some skill in using bow and arrow to hunt down rabbits and the like." + " +15 tracking for relevant checks.";
	}
});