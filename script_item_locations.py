...
#settlements
# bannedfns = ['isSouthern', 'getSpriteName', 'onSerialize', 'onDeserialize', 'buildNewLocation', 'onBuild', 'onBuildOne', 'onBuildTwo', 'getAttachedLocationsMax', 'getUIBackgroundLeft', 'getDescription', 'getUIDescription', 'getHousesMax', 'onBuildThree']
